...
namespace AspNetCore10WithApacheECharts.Entities
{
    public partial interface INorthwindContextProcedures
    {
        ...
        Task<List<proc_get_top_countries_salesResult>> proc_get_top_countries_salesAsync(int? top, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
