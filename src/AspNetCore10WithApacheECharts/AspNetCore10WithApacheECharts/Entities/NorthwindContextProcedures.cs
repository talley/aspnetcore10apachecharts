...
#nullable disable
using AspNetCore10WithApacheECharts.Entities;
...
namespace AspNetCore10WithApacheECharts.Entities
{
    ...
    public partial class NorthwindContextProcedures : INorthwindContextProcedures
    {
        ...
        public virtual async Task<List<proc_get_top_countries_salesResult>> proc_get_top_countries_salesAsync(int? top, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<proc_get_top_countries_salesResult>("EXEC @returnValue = [dbo].[proc_get_top_countries_sales] @top = @top", sqlParameters, cancellationToken);
